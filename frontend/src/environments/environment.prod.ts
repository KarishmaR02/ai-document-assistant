export const environment = {
  production: true,
  // Update this with your deployed backend URL (e.g., https://your-backend.onrender.com or https://your-backend.up.railway.app)
  apiBaseUrl: 'https://your-backend-api-url.onrender.com',
